...
function renderTempoPicker({ value, onChange, classes }: TTempoPickerProps) {
  ...
  return (
    <FormControl className={classes.formControl}>
      <InputLabel shrink id="select-tempo">
        Set note duration
      </InputLabel>
      <Select
...
function renderNoteRangePicker({
  value,
  onChange,
  classes,
}: TNoteRangePickerProps) {
  const onNoteFirstChange = (
    event: ChangeEvent<{
      name?: string | undefined
      value: unknown
    }>
...
export function renderCompositionDurationPicker({
  ...
  return (
    <FormControl className={classes.formControl}>
      <InputLabel shrink id="set-composition-duration">
